...
```mermaid
flowchart TD
    A[Ruhetag und aktive Erholung] --> B[Ruhetag]
    A --> C[Aktive Erholung]
    A --> D[Gesamtbelastung]

    B --> B1[Passive Ruhe<br/>Nervensystem beruhigen<br/>Gewebe entlasten]
    C --> C1[Sehr leichte Bewegung<br/>Durchblutung unterstützen<br/>Beweglichkeit erhalten]
    D --> D1[Training Alltag Schlaf<br/>Stress und Erholungslage]
