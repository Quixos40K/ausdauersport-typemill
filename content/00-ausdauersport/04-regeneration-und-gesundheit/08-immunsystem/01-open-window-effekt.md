...
```mermaid
flowchart TD
    A[Harte Ausdauerbelastung] --> B[Akuter Koerperstress]
    B --> C[Stresshormone steigen]
    B --> D[Energiespeicher sinken]
    B --> E[Immunzellen verteilen sich um]

    C --> F[Empfindliche Phase]
    D --> F
    E --> F

    F --> G[Schlaf und Energie passen]
    F --> H[Schlafmangel und Alltagsstress]

    G --> I[Regulation und Erholung]
    H --> J[Hoehere Infektanfaelligkeit]

    I --> K[Fenster schliesst sich]
    J --> L[Belastung reduzieren]
