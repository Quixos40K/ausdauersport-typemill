...
```mermaid
flowchart TD
    A[Ausdauertraining] --> B[Energiebedarf steigt]
    B --> C[Muskeln brauchen Energie]
    B --> D[Immunzellen brauchen Energie]

    D --> E[Entzündung regulieren]
    D --> F[Gewebe überwachen]
    D --> G[Reparatur begleiten]

    E --> H[Immunmetabolische Balance]
    F --> H
    G --> H

    H --> I[Ausreichend Schlaf und Energie]
    H --> J[Zu wenig Erholung und Energie]

    I --> K[Anpassung unterstützt]
    J --> L[Regeneration gestört]
