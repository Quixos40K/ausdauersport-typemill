...
```mermaid
flowchart TD
    A[Mehr Training] --> B{Aufbau passend?}

    B -->|Nein| C[Zu schnelle Steigerung]
    C --> D[Umfang oder Intensität steigt]
    D --> E[Erholung reicht nicht]
    E --> F[Outcome: Ermüdung und Leistungsabfall]

    B -->|Ja| G[Langsame Steigerung]
    G --> H[Lockere Einheiten einplanen]
    H --> I[Erholung sichern]
    I --> J[Outcome: Belastbarkeit und Leistung wachsen]
