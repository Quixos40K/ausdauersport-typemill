...
Trainingshäufigkeit beschreibt, wie oft innerhalb eines bestimmten Zeitraums trainiert wird. Im Ausdauertraining ist das wichtig, weil nicht nur die Menge des Trainings zählt, sondern auch die Verteilung der Reize über die Woche. Entscheidend ist, dass Trainingshäufigkeit zu Ziel, Umfang, Intensität, Erholung und Alltag passt.
...
Eine passende Trainingshäufigkeit hilft, Trainingsreize regelmäßig zu setzen, ohne den Körper dauerhaft zu überfordern.

## Warum Trainingshäufigkeit wichtig ist

Ausdaueranpassungen entstehen durch wiederholte Reize. Wer sehr selten trainiert, setzt oft zu wenige Signale für stabile Anpassung. Wer sehr häufig trainiert, kann zwar mehr Reize setzen, braucht aber auch mehr Regeneration und eine bessere Belastungssteuerung.

Trainingshäufigkeit beeinflusst außerdem, wie gut Trainingsumfang verteilt werden kann. Der gleiche Wochenumfang wirkt anders, wenn er auf zwei oder auf fünf Einheiten verteilt wird.
...
Je intensiver eine Einheit ist, desto mehr Erholung wird meist benötigt. Eine hohe Trainingshäufigkeit funktioniert deshalb nur dann gut, wenn nicht jede Einheit hart ist.
...
Schlaf, Ernährung, Alltagstress, Beruf, Familie und mentale Belastung beeinflussen, wie viele Einheiten sinnvoll verarbeitet werden können. Eine Trainingshäufigkeit, die in einer ruhigen Lebensphase funktioniert, kann in einer stressigen Phase zu viel sein.
...
Für Läufer ist Trainingshäufigkeit besonders wichtig, weil Laufen bei jeder Einheit mechanische Stoßbelastung erzeugt. Deshalb ist nicht nur entscheidend, wie oft trainiert wird, sondern auch, wie die Einheiten gestaltet sind.
