...
Jahresplanung beschreibt die grobe Struktur eines Trainingsjahres. Im Ausdauertraining ist das wichtig, weil Belastung, Erholung, Wettkampfvorbereitung und Leistungsentwicklung nichtung, Erholung, Wett zufällig entstehen sollten. Entscheidend ist, dass ein Trainingsjahr nicht aus einzelnen Wochen besteht, sondern aus sinnvoll verbundenen Trainingsphasen.

## Was Jahresplanung bedeutet

Jahresplanung ist die langfristige Einordnung von Training über mehrere Monate hinweg. Sie legt nicht jede einzelne Einheit im Detail fest, sondern beschreibt den Rahmen: Wann wird Grundlage aufgebaut, wann steigt die spezifische Belastung, wann stehen Wettkämpfe an und wann braucht der Körper bewusst Entlastung.
...
Viele Trainingsprobleme entstehen nicht durch eine einzelne schlechte Einheit, sondern durch eine schlecht aufgebaute Gesamtstruktur. Wenn harte Phasen zu früh kommen, Erholung fehlt oder Wettkämpfe ohne gezielte Vorbereitung geplant werden, steigt das Risiko für Überlastung, Stagnation und unnötige Ermüdung.
...
Jahresplanung wirkt vor allem über die sinnvolle Abfolge von Trainingsphasen. Ein typisches Trainingsjahr kann aus einer allgemeinen Aufbauphase, einer spezifischeren Vorbereitungsphase, einer Wettkampfphase und einer Übergangs- oder Regenerationsphase bestehen.
...
Wettkampftermine geben der Jahresplanung Ankerpunkte. Von einem Zielwettkampf aus kann rückwärts geplant werden: Wann beginnt die spezifische Vorbereitung, wann wird die Belastung reduziert und wann braucht es Erholung?
...
Ein Trainingsjahr sollte Belastung schrittweise entwickeln. Dabei geht es nicht nur um mehr Kilometer oder mehr Stunden, sondern auch um Intensität, Dichte, lange Läufe, Höhenmeter, Krafttraining und Gesamtstress.
...
Regeneration ist kein Restposten der Jahresplanung. Entlastungswochen, Ruhetage, Schlaf, Alltag und mentale Erholung gehören zur Struktur dazu.
...
Für Läufer ist Jahresplanung besonders wichtig, weil Lauftraining mechanisch belastend ist. Umfang, Intensität und Wettkampfvorbereitung wirken nicht nur auf das Herz-Kreislauf-System, sondern auch auf Sehnen, Knochen, Gelenke und Muskulatur.
...
```mermaid
graph TD
    A(Jahresplanung) --> B(Trainingsziel)
    A --> C(Trainingsphasen)
